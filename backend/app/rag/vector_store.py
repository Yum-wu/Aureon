...
_kw_avgdl: float = 0.0
_KW_MIN_RAW_SCORE = 0.5  # minimum raw BM25 score before normalization (lowered to avoid false negatives) before normalization
_KW_MIN_IDF = 0.5  # skip terms with very low IDF (appear in >80% docs)
