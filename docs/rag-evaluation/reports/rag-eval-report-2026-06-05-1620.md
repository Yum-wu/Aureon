...
| Context Precision | 0.725 | ≥0.70 | ✅ |
| Context Recall | 0.000 | ≥0.75 | ⚠️ |
| Context Relevancy | 0.333 | ≥0.70 | ⚠️ |

## 生成质量

| 指标 | 分数 | 阈值 | 状态 |
|------|------|------|------|
| Faithfulness | 0.970 | ≥0.70 | ✅ |
| Answer Relevancy | 0.660 | ≥0.60 | ✅ |
| Hallucination | 0.030 | ≤0.20 | ✅ |
