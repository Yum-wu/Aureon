...
| Context Precision | 0.409 | ≥0.70 | ⚠️ |
| Context Recall | 0.648 | ≥0.75 | ⚠️ |
| Context Relevancy | 0.297 | ≥0.70 | ⚠️ |

## 生成质量

| 指标 | 分数 | 阈值 | 状态 |
|------|------|------|------|
| Faithfulness | 0.956 | ≥0.70 | ✅ |
| Answer Relevancy | 0.602 | ≥0.60 | ✅ |
| Hallucination | 0.044 | ≤0.20 | ✅ |
