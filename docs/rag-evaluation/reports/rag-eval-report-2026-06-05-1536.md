...
| Context Precision | 0.414 | ≥0.70 | ⚠️ |
| Context Recall | 0.639 | ≥0.75 | ⚠️ |
| Context Relevancy | 0.259 | ≥0.70 | ⚠️ |

## 生成质量

| 指标 | 分数 | 阈值 | 状态 |
|------|------|------|------|
| Faithfulness | 0.982 | ≥0.70 | ✅ |
| Answer Relevancy | 0.671 | ≥0.60 | ✅ |
| Hallucination | 0.018 | ≤0.20 | ✅ |
